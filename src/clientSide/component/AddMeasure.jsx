  ...
  return (
    <div>
      ...
      <button
        ...
        className=' wow fadeInLeft text-green-900 mx-16 px-4 mt-4 mb-4  bg-transparent transition-all duration-300 border
      ...
      <TEModal show={showModal} setShow={setShowModal} FullscreenModal>
        <TEModalDialog className='rounded-3xl my-2'>
          <TEModalContent className='dark:bg-slate-200'>
            ...
            <div className='font-black '>
              {/* <!-- Modal title --> */}
              <h5 className='text-xl font-medium text-center sm'>
                Edit Measurement
              </h5>
            ...
            <TEModalBody>
              <div
                className=' wow fadeInLeft  mt-2 mb-4 mx-auto md:w-full bg-transparent transition-all duration-300 border
                      border-opacity-50 rounded-3xl p-1 lg:p-8 text-center flex flex-col space-y-6 '
              >
                <div>
