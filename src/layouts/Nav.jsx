...
const Nav = () => {
    ...
    return (
        <nav
            className="text-gray-600 m-0 md:p-5 text-base xl:text-lg font-medium bg-white py-4 
            ...
            <div className="flex space-x-4 items-center justify-evenly px-3 py-0 xl:py-0">
                ...
                <div className="md:hidden relative">
                    <Menu as="div" className="relative inline-block text-center ">
                        <Menu.Button
                            className="inline-flex w-full justify-center rounded-md bg-gray-200 shadow-2xl
